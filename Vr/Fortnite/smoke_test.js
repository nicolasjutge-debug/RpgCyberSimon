(function(){
  ...
  try{
    ...
    if(profileBtn){ profileBtn.click(); setTimeout(function(){ var modal = document.getElementById('profileModal'); if(modal && getComputedStyle(modal).display!=='none') ok('Modal Profile ouvre correctement'); else fail('Modal Profile ne s\'ouvre pas'); var close = document.getElementById('closeProfile'); if(close){ close.click(); } }, 250); }
